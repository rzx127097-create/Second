        ...
        view.update(
            {
                ...
                "ecology_global_context_before": self.ecology_global_context_before,
                 ...
                 "initial_total_predator": float(np.sum(self.initial_predator)),
                 "final_total_predator": float(transition.predator_after_total),
                 "concentration_mean": float(np.mean(self.ecology.concentration)),
                 "concentration_max": float(np.max(self.ecology.concentration)),
                 "terminal_wind_direction": float(math.atan2(transition.wind_vector[1], transition.wind_vector[0])),
                 "terminal_wind_strength": float(math.hypot(*transition.wind_vector)),
